...
namespace WeatherApp
{
    ...
    public class weather_activity : AppCompatActivity
    {
        ...
        public void Control()
        {
            ...
            humidityTextView = (TextView)FindViewById(Resource.Id.humidity);
            temp_min = (TextView)FindViewById(Resource.Id.temp_min);
            temp_max = (TextView)FindViewById(Resource.Id.temp_max);
