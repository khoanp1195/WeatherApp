...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WeatherApp.EventListener.TaskCompletionListener, WeatherApp", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("WeatherApp.EventListener.TaskCompletionListener, WeatherApp", "", this, new java.lang.Object[] {  });
	}
